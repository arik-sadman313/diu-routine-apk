            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                <select
                  ...
                  disabled={deleting}
                  className="w-full bg-slate-100 dark:bg-slate-800 border-none rounded-lg px-3 py-2 text-xs text-slate-700 dark:text-slate-300 focus:ring-2 focus:ring-accent-500/50 outline-none appearance-none font-medium pr-7 truncate cursor-pointer disabled:opacity-50"
                >
                  {versions.map(v => (
