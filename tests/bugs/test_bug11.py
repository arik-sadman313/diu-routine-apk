...
def test_repro():
    ...
    # query effective classes BEFORE edit
    ...
    # query effective classes AFTER edit
    ...
    if count_edited > count_orig:
        print("DUPLICATE BUG CONFIRMED!!!")
    elif count_edited == count_orig:
        print("NO DUPLICATE BUG.")
